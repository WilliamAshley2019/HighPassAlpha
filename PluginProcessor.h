...
class HighpassAudioProcessor : public juce::AudioProcessor
{
public:
    HighpassAudioProcessor();
    ~HighpassAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(HighpassAudioProcessor)
};
